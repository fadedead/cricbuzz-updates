...
log_file_name = "fetcher.log"
Logger(log_file_name)
Logger.log_info(f"Starting execution for fetcher...")
...
async def fetch_completed_match_data():
    ...
    """
    while True:
        _, completed_matches = fetch_live_and_completed_matches()
...
async def fetch_running_match_data():
    ...
    """
    while True:
        active_matches, _ = fetch_live_and_completed_matches()
        ...
        await asyncio.sleep(constants.GAME_UPDATE_FETCHER_SLEEP_TIME)
